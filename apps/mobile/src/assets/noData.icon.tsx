...
const NoDataIcon: React.FC = () => {
  ...
  return (
    <Svg height={256} viewBox='0 0 647.63626 632.17383' width={256}>
      ...
      />
      <Circle cx={190.15351} cy={24.95465} fill={THEME.colors.primary[500]} r={20} />
      <Circle cx={190.15351} cy={24.95465} fill={THEME[colorScheme].background} r={12.66462} />
      <Path
      ...
      <Path
        ...
        fill={THEME.colors.primary[500]}
      />
      <Circle cx={433.63626} cy={105.17383} fill={THEME.colors.primary[500]} r={20} />
      <Circle cx={433.63626} cy={105.17383} fill={THEME[colorScheme].background} r={12.18187} />
    </Svg>
  );
};
