...
const NoDataIcon: React.FC = () => {
  ...
  return (
    <Svg viewBox='0 0 647.63626 632.17383' width={256} height={256}>
      ...
      />
      <Circle cx={190.15351} cy={24.95465} r={20} fill={colorsTheme.primary[500]} />
      <Circle cx={190.15351} cy={24.95465} r={12.66462} fill={colorsTheme.background[colorScheme]} />
      <Path
        fill={colorsTheme.primary[50]}
      ...
      />
      <Circle cx={433.63626} cy={105.17383} r={20} fill={colorsTheme.primary[500]} />
      <Circle cx={433.63626} cy={105.17383} r={12.18187} fill={colorsTheme.background[colorScheme]} />
    </Svg>
  );
};
