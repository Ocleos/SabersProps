...
const NoDataIcon: React.FC = () => {
  ...
  const [primary50Color, primary500Color, primary800Color] = useCSSVariable([
    '--color-primary-50',
    '--color-primary-500',
    '--color-primary-800',
  ]) as string[];
  ...
  return (
    <Svg height={256} viewBox='0 0 647.63626 632.17383' width={256}>
      ...
      <Path
        ...
        fill={primary500Color}
      />
      <Circle cx={190.15351} cy={24.95465} fill={primary500Color} r={20} />
      <Circle cx={190.15351} cy={24.95465} fill={backgroundColor} r={12.66462} />
      <Path
      ...
      <Path
        ...
        fill={primary500Color}
      />
      <Circle cx={433.63626} cy={105.17383} fill={primary500Color} r={20} />
      <Circle cx={433.63626} cy={105.17383} fill={backgroundColor} r={12.18187} />
    </Svg>
  );
};
