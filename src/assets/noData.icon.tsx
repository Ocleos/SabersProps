...
const NoDataIcon: React.FC<IIconProps> = (props) => {
  ...
  return (
    <Icon viewBox="0 0 647.63626 632.17383" {...props}>
      <Path
        fill={useColorModeValue(colors.light['100'], colors.light['800'])}
      ...
      />
      <Path
        fill={useColorModeValue(colors.gray['700'], colors.gray['200'])}
      ...
      />
      <Circle cx={190.15351} cy={24.95465} r={20} fill={colors.primary['500']} />
      <Circle cx={190.15351} cy={24.95465} r={12.66462} fill={useColorModeValue(colors.white, colors.black)} />
      <Path
        fill={useColorModeValue(colors.light['200'], colors.light['700'])}
      ...
      />
      <Circle cx={433.63626} cy={105.17383} r={20} fill={colors.primary['500']} />
      <Circle cx={433.63626} cy={105.17383} r={12.18187} fill={useColorModeValue(colors.white, colors.black)} />
    </Icon>
  );
};
